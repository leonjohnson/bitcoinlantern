...
class Tx:
    ...
    def create(self, target_amount_in_btc: float, change_amount_in_btc: float):
        prev_tx = bytes.fromhex('0d6fe5213c0b3291f208cba8bfb59b7476dffacc4e5cb66f6\ eb20a080843a299')
        prev_index = 13
        ...
        change_output = TxOut(amount=change_amount_in_btc, script_pubkey=change_script)
        
        target_amount = int(target_amount_in_btc*100000000)
        target_h160 = decode_base58('mnrVtF8DWjMu839VW3rBfgYaAfKk8983Xf')
        target_script = p2pkh_script(target_h160)
        target_output = TxOut(amount=target_amount_in_btc, script_pubkey=target_script)
